...
module Bindings (F : Cstubs.FOREIGN) = struct
  ...
  let xed3_operand_get_evexrr = foreign "xed3_operand_get_evexrr" (decoded_inst_arg @-> returning int)
  ...
  let xed3_operand_get_no_scale_disp8 = foreign "xed3_operand_get_no_scale_disp8" (decoded_inst_arg @-> returning int)
  ...
  let xed3_operand_get_sib = foreign "xed3_operand_get_sib" (decoded_inst_arg @-> returning int)
  ...
  let xed3_operand_get_skip_osz = foreign "xed3_operand_get_skip_osz" (decoded_inst_arg @-> returning int)
  ...
  let xed3_operand_get_type = foreign "xed3_operand_get_type" (decoded_inst_arg @-> returning operand_element_type_enum)
  ...
  let xed3_operand_set_evexrr = foreign "xed3_operand_set_evexrr" (decoded_inst_mut @-> int @-> returning void)
  ...
  let xed3_operand_set_no_scale_disp8 = foreign "xed3_operand_set_no_scale_disp8" (decoded_inst_mut @-> int @-> returning void)
  ...
  let xed3_operand_set_sib = foreign "xed3_operand_set_sib" (decoded_inst_mut @-> int @-> returning void)
  ...
  let xed3_operand_set_skip_osz = foreign "xed3_operand_set_skip_osz" (decoded_inst_mut @-> int @-> returning void)
  ...
  let xed3_operand_set_type = foreign "xed3_operand_set_type" (decoded_inst_mut @-> operand_element_type_enum @-> returning void)
  ...
  let xed_decoded_inst_get_nprefixes = foreign "xed_decoded_inst_get_nprefixes" (decoded_inst_mut @-> returning int)
  ...
  let xed_encoder_request_set_rep = foreign "xed_encoder_request_set_rep" (encoder_request_mut @-> returning void)
  let xed_encoder_request_set_repne = foreign "xed_encoder_request_set_repne" (encoder_request_mut @-> returning void)

...
value stub__1_str2xed_address_width_enum_t(value x1)
{
   char* x2 = CTYPES_ADDR_OF_FATPTR(x1);
   int x3 = str2xed_address_width_enum_t(x2);
   return Val_long(x3);
}
value stub__2_str2xed_attribute_enum_t(value x4)
{
   char* x5 = CTYPES_ADDR_OF_FATPTR(x4);
   int x6 = str2xed_attribute_enum_t(x5);
   return Val_long(x6);
}
value stub__3_str2xed_category_enum_t(value x7)
{
   char* x8 = CTYPES_ADDR_OF_FATPTR(x7);
   int x9 = str2xed_category_enum_t(x8);
   return Val_long(x9);
}
value stub__4_str2xed_chip_enum_t(value x10)
{
   char* x11 = CTYPES_ADDR_OF_FATPTR(x10);
   int x12 = str2xed_chip_enum_t(x11);
   return Val_long(x12);
}
value stub__5_str2xed_cpuid_bit_enum_t(value x13)
{
   char* x14 = CTYPES_ADDR_OF_FATPTR(x13);
   int x15 = str2xed_cpuid_bit_enum_t(x14);
   return Val_long(x15);
}
value stub__6_str2xed_error_enum_t(value x16)
{
   char* x17 = CTYPES_ADDR_OF_FATPTR(x16);
   int x18 = str2xed_error_enum_t(x17);
   return Val_long(x18);
}
value stub__7_str2xed_exception_enum_t(value x19)
{
   char* x20 = CTYPES_ADDR_OF_FATPTR(x19);
   int x21 = str2xed_exception_enum_t(x20);
   return Val_long(x21);
}
value stub__8_str2xed_extension_enum_t(value x22)
{
   char* x23 = CTYPES_ADDR_OF_FATPTR(x22);
   int x24 = str2xed_extension_enum_t(x23);
   return Val_long(x24);
}
value stub__9_str2xed_flag_action_enum_t(value x25)
{
   char* x26 = CTYPES_ADDR_OF_FATPTR(x25);
   int x27 = str2xed_flag_action_enum_t(x26);
   return Val_long(x27);
}
value stub__10_str2xed_flag_enum_t(value x28)
{
   char* x29 = CTYPES_ADDR_OF_FATPTR(x28);
   int x30 = str2xed_flag_enum_t(x29);
   return Val_long(x30);
}
value stub__11_str2xed_iclass_enum_t(value x31)
{
   char* x32 = CTYPES_ADDR_OF_FATPTR(x31);
   int x33 = str2xed_iclass_enum_t(x32);
   return Val_long(x33);
}
value stub__12_str2xed_iform_enum_t(value x34)
{
   char* x35 = CTYPES_ADDR_OF_FATPTR(x34);
   int x36 = str2xed_iform_enum_t(x35);
   return Val_long(x36);
}
value stub__13_str2xed_isa_set_enum_t(value x37)
{
   char* x38 = CTYPES_ADDR_OF_FATPTR(x37);
   int x39 = str2xed_isa_set_enum_t(x38);
   return Val_long(x39);
}
value stub__14_str2xed_machine_mode_enum_t(value x40)
{
   char* x41 = CTYPES_ADDR_OF_FATPTR(x40);
   int x42 = str2xed_machine_mode_enum_t(x41);
   return Val_long(x42);
}
value stub__15_str2xed_nonterminal_enum_t(value x43)
{
   char* x44 = CTYPES_ADDR_OF_FATPTR(x43);
   int x45 = str2xed_nonterminal_enum_t(x44);
   return Val_long(x45);
}
value stub__16_str2xed_operand_action_enum_t(value x46)
{
   char* x47 = CTYPES_ADDR_OF_FATPTR(x46);
   int x48 = str2xed_operand_action_enum_t(x47);
   return Val_long(x48);
}
value stub__17_str2xed_operand_convert_enum_t(value x49)
{
   char* x50 = CTYPES_ADDR_OF_FATPTR(x49);
   int x51 = str2xed_operand_convert_enum_t(x50);
   return Val_long(x51);
}
value stub__18_str2xed_operand_element_type_enum_t(value x52)
{
   char* x53 = CTYPES_ADDR_OF_FATPTR(x52);
   int x54 = str2xed_operand_element_type_enum_t(x53);
   return Val_long(x54);
}
value stub__19_str2xed_operand_element_xtype_enum_t(value x55)
{
   char* x56 = CTYPES_ADDR_OF_FATPTR(x55);
   int x57 = str2xed_operand_element_xtype_enum_t(x56);
   return Val_long(x57);
}
value stub__20_str2xed_operand_enum_t(value x58)
{
   char* x59 = CTYPES_ADDR_OF_FATPTR(x58);
   int x60 = str2xed_operand_enum_t(x59);
   return Val_long(x60);
}
value stub__21_str2xed_operand_type_enum_t(value x61)
{
   char* x62 = CTYPES_ADDR_OF_FATPTR(x61);
   int x63 = str2xed_operand_type_enum_t(x62);
   return Val_long(x63);
}
value stub__22_str2xed_operand_visibility_enum_t(value x64)
{
   char* x65 = CTYPES_ADDR_OF_FATPTR(x64);
   int x66 = str2xed_operand_visibility_enum_t(x65);
   return Val_long(x66);
}
value stub__23_str2xed_operand_width_enum_t(value x67)
{
   char* x68 = CTYPES_ADDR_OF_FATPTR(x67);
   int x69 = str2xed_operand_width_enum_t(x68);
   return Val_long(x69);
}
value stub__24_str2xed_reg_class_enum_t(value x70)
{
   char* x71 = CTYPES_ADDR_OF_FATPTR(x70);
   int x72 = str2xed_reg_class_enum_t(x71);
   return Val_long(x72);
}
value stub__25_str2xed_reg_enum_t(value x73)
{
   char* x74 = CTYPES_ADDR_OF_FATPTR(x73);
   int x75 = str2xed_reg_enum_t(x74);
   return Val_long(x75);
}
value stub__26_str2xed_syntax_enum_t(value x76)
{
   char* x77 = CTYPES_ADDR_OF_FATPTR(x76);
   int x78 = str2xed_syntax_enum_t(x77);
   return Val_long(x78);
}
value stub__27_xed3_operand_get_agen(value x79)
{
   const xed_decoded_inst_t* x80 = CTYPES_ADDR_OF_FATPTR(x79);
   int x81 = xed3_operand_get_agen(x80);
   return Val_long(x81);
}
value stub__28_xed3_operand_get_amd3dnow(value x82)
{
   const xed_decoded_inst_t* x83 = CTYPES_ADDR_OF_FATPTR(x82);
   int x84 = xed3_operand_get_amd3dnow(x83);
   return Val_long(x84);
}
value stub__29_xed3_operand_get_asz(value x85)
{
   const xed_decoded_inst_t* x86 = CTYPES_ADDR_OF_FATPTR(x85);
   int x87 = xed3_operand_get_asz(x86);
   return Val_long(x87);
}
value stub__30_xed3_operand_get_base0(value x88)
{
   const xed_decoded_inst_t* x89 = CTYPES_ADDR_OF_FATPTR(x88);
   int x90 = xed3_operand_get_base0(x89);
   return Val_long(x90);
}
value stub__31_xed3_operand_get_base1(value x91)
{
   const xed_decoded_inst_t* x92 = CTYPES_ADDR_OF_FATPTR(x91);
   int x93 = xed3_operand_get_base1(x92);
   return Val_long(x93);
}
value stub__32_xed3_operand_get_bcast(value x94)
{
   const xed_decoded_inst_t* x95 = CTYPES_ADDR_OF_FATPTR(x94);
   int x96 = xed3_operand_get_bcast(x95);
   return Val_long(x96);
}
value stub__33_xed3_operand_get_bcrc(value x97)
{
   const xed_decoded_inst_t* x98 = CTYPES_ADDR_OF_FATPTR(x97);
   int x99 = xed3_operand_get_bcrc(x98);
   return Val_long(x99);
}
value stub__34_xed3_operand_get_brdisp_width(value x100)
{
   const xed_decoded_inst_t* x101 = CTYPES_ADDR_OF_FATPTR(x100);
   char x102 = xed3_operand_get_brdisp_width(x101);
   return Ctypes_val_char(x102);
}
value stub__35_xed3_operand_get_cet(value x103)
{
   const xed_decoded_inst_t* x104 = CTYPES_ADDR_OF_FATPTR(x103);
   int x105 = xed3_operand_get_cet(x104);
   return Val_long(x105);
}
value stub__36_xed3_operand_get_chip(value x106)
{
   const xed_decoded_inst_t* x107 = CTYPES_ADDR_OF_FATPTR(x106);
   int x108 = xed3_operand_get_chip(x107);
   return Val_long(x108);
}
value stub__37_xed3_operand_get_default_seg(value x109)
{
   const xed_decoded_inst_t* x110 = CTYPES_ADDR_OF_FATPTR(x109);
   int x111 = xed3_operand_get_default_seg(x110);
   return Val_long(x111);
}
value stub__38_xed3_operand_get_df32(value x112)
{
   const xed_decoded_inst_t* x113 = CTYPES_ADDR_OF_FATPTR(x112);
   int x114 = xed3_operand_get_df32(x113);
   return Val_long(x114);
}
value stub__39_xed3_operand_get_df64(value x115)
{
   const xed_decoded_inst_t* x116 = CTYPES_ADDR_OF_FATPTR(x115);
   int x117 = xed3_operand_get_df64(x116);
   return Val_long(x117);
}
value stub__40_xed3_operand_get_disp(value x118)
{
   const xed_decoded_inst_t* x119 = CTYPES_ADDR_OF_FATPTR(x118);
   int64_t x120 = xed3_operand_get_disp(x119);
   return caml_copy_int64(x120);
}
value stub__41_xed3_operand_get_disp_width(value x121)
{
   const xed_decoded_inst_t* x122 = CTYPES_ADDR_OF_FATPTR(x121);
   char x123 = xed3_operand_get_disp_width(x122);
   return Ctypes_val_char(x123);
}
value stub__42_xed3_operand_get_dummy(value x124)
{
   const xed_decoded_inst_t* x125 = CTYPES_ADDR_OF_FATPTR(x124);
   int x126 = xed3_operand_get_dummy(x125);
   return Val_long(x126);
}
value stub__43_xed3_operand_get_easz(value x127)
{
   const xed_decoded_inst_t* x128 = CTYPES_ADDR_OF_FATPTR(x127);
   int x129 = xed3_operand_get_easz(x128);
   return Val_long(x129);
}
value stub__44_xed3_operand_get_element_size(value x130)
{
   const xed_decoded_inst_t* x131 = CTYPES_ADDR_OF_FATPTR(x130);
   int x132 = xed3_operand_get_element_size(x131);
   return Val_long(x132);
}
value stub__45_xed3_operand_get_encoder_preferred(value x133)
{
   const xed_decoded_inst_t* x134 = CTYPES_ADDR_OF_FATPTR(x133);
   int x135 = xed3_operand_get_encoder_preferred(x134);
   return Val_long(x135);
}
value stub__46_xed3_operand_get_eosz(value x136)
{
   const xed_decoded_inst_t* x137 = CTYPES_ADDR_OF_FATPTR(x136);
   int x138 = xed3_operand_get_eosz(x137);
   return Val_long(x138);
}
value stub__47_xed3_operand_get_error(value x139)
{
   const xed_decoded_inst_t* x140 = CTYPES_ADDR_OF_FATPTR(x139);
   int x141 = xed3_operand_get_error(x140);
   return Val_long(x141);
}
value stub__48_xed3_operand_get_esrc(value x142)
{
   const xed_decoded_inst_t* x143 = CTYPES_ADDR_OF_FATPTR(x142);
   int x144 = xed3_operand_get_esrc(x143);
   return Val_long(x144);
}
value stub__49_xed3_operand_get_evexrr(value x145)
{
   const xed_decoded_inst_t* x146 = CTYPES_ADDR_OF_FATPTR(x145);
   int x147 = xed3_operand_get_evexrr(x146);
   return Val_long(x147);
}
value stub__50_xed3_operand_get_first_f2f3(value x148)
{
   const xed_decoded_inst_t* x149 = CTYPES_ADDR_OF_FATPTR(x148);
   int x150 = xed3_operand_get_first_f2f3(x149);
   return Val_long(x150);
}
value stub__51_xed3_operand_get_has_modrm(value x151)
{
   const xed_decoded_inst_t* x152 = CTYPES_ADDR_OF_FATPTR(x151);
   int x153 = xed3_operand_get_has_modrm(x152);
   return Val_long(x153);
}
value stub__52_xed3_operand_get_has_sib(value x154)
{
   const xed_decoded_inst_t* x155 = CTYPES_ADDR_OF_FATPTR(x154);
   int x156 = xed3_operand_get_has_sib(x155);
   return Val_long(x156);
}
value stub__53_xed3_operand_get_hint(value x157)
{
   const xed_decoded_inst_t* x158 = CTYPES_ADDR_OF_FATPTR(x157);
   int x159 = xed3_operand_get_hint(x158);
   return Val_long(x159);
}
value stub__54_xed3_operand_get_iclass(value x160)
{
   const xed_decoded_inst_t* x161 = CTYPES_ADDR_OF_FATPTR(x160);
   int x162 = xed3_operand_get_iclass(x161);
   return Val_long(x162);
}
value stub__55_xed3_operand_get_ild_f2(value x163)
{
   const xed_decoded_inst_t* x164 = CTYPES_ADDR_OF_FATPTR(x163);
   int x165 = xed3_operand_get_ild_f2(x164);
   return Val_long(x165);
}
value stub__56_xed3_operand_get_ild_f3(value x166)
{
   const xed_decoded_inst_t* x167 = CTYPES_ADDR_OF_FATPTR(x166);
   int x168 = xed3_operand_get_ild_f3(x167);
   return Val_long(x168);
}
value stub__57_xed3_operand_get_ild_seg(value x169)
{
   const xed_decoded_inst_t* x170 = CTYPES_ADDR_OF_FATPTR(x169);
   int x171 = xed3_operand_get_ild_seg(x170);
   return Val_long(x171);
}
value stub__58_xed3_operand_get_imm0(value x172)
{
   const xed_decoded_inst_t* x173 = CTYPES_ADDR_OF_FATPTR(x172);
   int x174 = xed3_operand_get_imm0(x173);
   return Val_long(x174);
}
value stub__59_xed3_operand_get_imm0signed(value x175)
{
   const xed_decoded_inst_t* x176 = CTYPES_ADDR_OF_FATPTR(x175);
   int x177 = xed3_operand_get_imm0signed(x176);
   return Val_long(x177);
}
value stub__60_xed3_operand_get_imm1(value x178)
{
   const xed_decoded_inst_t* x179 = CTYPES_ADDR_OF_FATPTR(x178);
   int x180 = xed3_operand_get_imm1(x179);
   return Val_long(x180);
}
value stub__61_xed3_operand_get_imm1_bytes(value x181)
{
   const xed_decoded_inst_t* x182 = CTYPES_ADDR_OF_FATPTR(x181);
   int x183 = xed3_operand_get_imm1_bytes(x182);
   return Val_long(x183);
}
value stub__62_xed3_operand_get_imm_width(value x184)
{
   const xed_decoded_inst_t* x185 = CTYPES_ADDR_OF_FATPTR(x184);
   char x186 = xed3_operand_get_imm_width(x185);
   return Ctypes_val_char(x186);
}
value stub__63_xed3_operand_get_index(value x187)
{
   const xed_decoded_inst_t* x188 = CTYPES_ADDR_OF_FATPTR(x187);
   int x189 = xed3_operand_get_index(x188);
   return Val_long(x189);
}
value stub__64_xed3_operand_get_last_f2f3(value x190)
{
   const xed_decoded_inst_t* x191 = CTYPES_ADDR_OF_FATPTR(x190);
   int x192 = xed3_operand_get_last_f2f3(x191);
   return Val_long(x192);
}
value stub__65_xed3_operand_get_llrc(value x193)
{
   const xed_decoded_inst_t* x194 = CTYPES_ADDR_OF_FATPTR(x193);
   int x195 = xed3_operand_get_llrc(x194);
   return Val_long(x195);
}
value stub__66_xed3_operand_get_lock(value x196)
{
   const xed_decoded_inst_t* x197 = CTYPES_ADDR_OF_FATPTR(x196);
   int x198 = xed3_operand_get_lock(x197);
   return Val_long(x198);
}
value stub__67_xed3_operand_get_lzcnt(value x199)
{
   const xed_decoded_inst_t* x200 = CTYPES_ADDR_OF_FATPTR(x199);
   int x201 = xed3_operand_get_lzcnt(x200);
   return Val_long(x201);
}
value stub__68_xed3_operand_get_map(value x202)
{
   const xed_decoded_inst_t* x203 = CTYPES_ADDR_OF_FATPTR(x202);
   int x204 = xed3_operand_get_map(x203);
   return Val_long(x204);
}
value stub__69_xed3_operand_get_mask(value x205)
{
   const xed_decoded_inst_t* x206 = CTYPES_ADDR_OF_FATPTR(x205);
   int x207 = xed3_operand_get_mask(x206);
   return Val_long(x207);
}
value stub__70_xed3_operand_get_max_bytes(value x208)
{
   const xed_decoded_inst_t* x209 = CTYPES_ADDR_OF_FATPTR(x208);
   int x210 = xed3_operand_get_max_bytes(x209);
   return Val_long(x210);
}
value stub__71_xed3_operand_get_mem0(value x211)
{
   const xed_decoded_inst_t* x212 = CTYPES_ADDR_OF_FATPTR(x211);
   int x213 = xed3_operand_get_mem0(x212);
   return Val_long(x213);
}
value stub__72_xed3_operand_get_mem1(value x214)
{
   const xed_decoded_inst_t* x215 = CTYPES_ADDR_OF_FATPTR(x214);
   int x216 = xed3_operand_get_mem1(x215);
   return Val_long(x216);
}
value stub__73_xed3_operand_get_mem_width(value x217)
{
...
{
   const xed_decoded_inst_t* x221 = CTYPES_ADDR_OF_FATPTR(x220);
   int x222 = xed3_operand_get_mod(x221);
   return Val_long(x222);
}
value stub__75_xed3_operand_get_mode(value x223)
{
   const xed_decoded_inst_t* x224 = CTYPES_ADDR_OF_FATPTR(x223);
   int x225 = xed3_operand_get_mode(x224);
   return Val_long(x225);
}
value stub__76_xed3_operand_get_mode_first_prefix(value x226)
{
   const xed_decoded_inst_t* x227 = CTYPES_ADDR_OF_FATPTR(x226);
   int x228 = xed3_operand_get_mode_first_prefix(x227);
   return Val_long(x228);
}
value stub__77_xed3_operand_get_modep5(value x229)
{
   const xed_decoded_inst_t* x230 = CTYPES_ADDR_OF_FATPTR(x229);
   int x231 = xed3_operand_get_modep5(x230);
   return Val_long(x231);
}
value stub__78_xed3_operand_get_modep55c(value x232)
{
   const xed_decoded_inst_t* x233 = CTYPES_ADDR_OF_FATPTR(x232);

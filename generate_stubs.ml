let main () =
  let ml_out = open_out "generated/ForeignGenerated.ml"
  ...
  Cstubs.write_ml ml_fmt ~prefix:"stub_" (module Functions.Bindings);
  Cstubs.write_c c_fmt ~prefix:"stub_" (module Functions.Bindings);

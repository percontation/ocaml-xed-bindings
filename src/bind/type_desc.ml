module Types (F : Cstubs.Types.TYPE) = struct
  ...
  type decoded_inst
  let decoded_inst : decoded_inst abstract typ = abstract ~name:"xed_decoded_inst_t" ~size:192 ~alignment:8
  ...
  let encoder_request : encoder_request abstract typ = abstract ~name:"xed_encoder_request_t" ~size:192 ~alignment:8
  ...
  type operand_values
  let operand_values : operand_values abstract typ = abstract ~name:"xed_operand_values_t" ~size:192 ~alignment:8

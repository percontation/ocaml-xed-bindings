...
open F
  ...
  let xed3_operand_get_rexrr = foreign "xed3_operand_get_rexrr" ((ptr decoded_inst) @-> returning int)
  ...
  let xed3_operand_set_rexrr = foreign "xed3_operand_set_rexrr" ((ptr decoded_inst) @-> int @-> returning void)
  ...
  let xed_decoded_inst_get_branch_displacement = foreign "xed_decoded_inst_get_branch_displacement" ((ptr decoded_inst) @-> returning int32_t)
  ...
  let xed_decoded_inst_set_branch_displacement = foreign "xed_decoded_inst_set_branch_displacement" ((ptr decoded_inst) @-> int32_t @-> int @-> returning void)
  let xed_decoded_inst_set_branch_displacement_bits = foreign "xed_decoded_inst_set_branch_displacement_bits" ((ptr decoded_inst) @-> int32_t @-> int @-> returning void)
  ...
  let xed_encoder_request_set_branch_displacement = foreign "xed_encoder_request_set_branch_displacement" ((ptr encoder_request) @-> int32_t @-> int @-> returning void)
  ...
  let xed_operand_values_get_branch_displacement_int32 = foreign "xed_operand_values_get_branch_displacement_int32" ((ptr operand_values) @-> returning int32_t)
  ...
  let xed_operand_values_set_branch_displacement = foreign "xed_operand_values_set_branch_displacement" ((ptr operand_values) @-> int32_t @-> int @-> returning void)
  let xed_operand_values_set_branch_displacement_bits = foreign "xed_operand_values_set_branch_displacement_bits" ((ptr operand_values) @-> int32_t @-> int @-> returning void)

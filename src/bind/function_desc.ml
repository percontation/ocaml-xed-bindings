...
open F
  ...
  let xed3_operand_get_dfv = foreign "xed3_operand_get_dfv" ((ptr decoded_inst) @-> returning int)
  ...
  let xed3_operand_get_enc_delete = foreign "xed3_operand_get_enc_delete" ((ptr decoded_inst) @-> returning int)
  ...
  let xed3_operand_get_ibhf = foreign "xed3_operand_get_ibhf" ((ptr decoded_inst) @-> returning int)
  ...
  let xed3_operand_get_prefetchit = foreign "xed3_operand_get_prefetchit" ((ptr decoded_inst) @-> returning int)
  let xed3_operand_get_prefetchrst = foreign "xed3_operand_get_prefetchrst" ((ptr decoded_inst) @-> returning int)
  ...
  let xed3_operand_set_dfv = foreign "xed3_operand_set_dfv" ((ptr decoded_inst) @-> int @-> returning void)
  ...
  let xed3_operand_set_enc_delete = foreign "xed3_operand_set_enc_delete" ((ptr decoded_inst) @-> int @-> returning void)
  ...
  let xed3_operand_set_ibhf = foreign "xed3_operand_set_ibhf" ((ptr decoded_inst) @-> int @-> returning void)
  ...
  let xed3_operand_set_prefetchit = foreign "xed3_operand_set_prefetchit" ((ptr decoded_inst) @-> int @-> returning void)
  let xed3_operand_set_prefetchrst = foreign "xed3_operand_set_prefetchrst" ((ptr decoded_inst) @-> int @-> returning void)
  ...
  let xed_classify_apx_foundation = foreign "xed_classify_apx_foundation" ((ptr decoded_inst) @-> returning bool)
  ...
  let xed_decoded_inst_get_default_flags_values = foreign "xed_decoded_inst_get_default_flags_values" ((ptr decoded_inst) @-> (ptr flag_dfv) @-> returning bool)
  ...
  let xed_decoded_inst_has_default_flags_values = foreign "xed_decoded_inst_has_default_flags_values" ((ptr decoded_inst) @-> returning bool)
  ...
  let xed_decoded_inst_valid_for_features = foreign "xed_decoded_inst_valid_for_features" ((ptr decoded_inst) @-> (ptr chip_features) @-> returning bool)
  ...
  let xed_operand_print = foreign "xed_operand_print" ((ptr decoded_inst) @-> int @-> ocaml_bytes @-> int @-> returning void)
  ...
  let xed_operand_values_ignored_branch_not_taken_hint = foreign "xed_operand_values_ignored_branch_not_taken_hint" ((ptr operand_values) @-> returning bool)
  let xed_operand_values_ignored_branch_taken_hint = foreign "xed_operand_values_ignored_branch_taken_hint" ((ptr operand_values) @-> returning bool)
  ...
  let xed_set_decoder_modes = foreign "xed_set_decoder_modes" ((ptr decoded_inst) @-> chip_enum @-> (ptr chip_features) @-> returning void)
